...
HELP_COMMANDS = [
    ...
    ["scripts/set_github_repository_metadata.py", "--help"],
...
SCRIPT_EXPECTATIONS = [
    ...
    (
        ...
        [
            "DEFAULT_HOMEPAGE",
            "--expected-homepage",
            "repository homepage matches the release metadata contract",
        ],
    ),
    (
        "scripts/set_github_repository_metadata.py",
...
DOC_EXPECTATIONS = [
    ...
    (
        ...
        [
            ...
            "--dry-run",
            "unset HF_TOKEN",
            "Use a clean clone or `git archive`",
            "not a manually zipped working directory",
        ],
    ),
    (
        "docs/github_repository_setup.md",
