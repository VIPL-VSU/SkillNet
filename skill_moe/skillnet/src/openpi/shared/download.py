...
def _download_boto3(
    ...
    *,
    ...
    """Download a file from the public model asset S3 bucket using boto3.

    Input:
        url: URL to a checkpoint or model asset path.
...
def _is_openpi_url(url: str) -> bool:
    """Check if the url is the public base-runtime S3 bucket url."""
