...
class DataConfig:
    ...
    # Only used for optional RLDS data loaders. The public SkillNet configs use LeRobot datasets.
...
@dataclasses.dataclass(frozen=True)
class LeRobotRobotwinSkillDataConfig(DataConfigFactory):
    """Configure RoboTwin LeRobot samples for SkillNet few-shot training."""
                ...
                _transforms.RepackTransform(
                    {
                        ...
                        "hand_right_color": "hand_right_color",
                        "hand_left_color": "hand_left_color",
                        "state": "state",
                        "actions": "actions",
                        "prompt": "prompt",
                        "skills": "skills",
...
@dataclasses.dataclass(frozen=True)
class LeRobotLiberoSkillDataConfig(DataConfigFactory):
    """
    This config is used to configure transforms that are applied at various parts of the data pipeline.
    For your own dataset, you can copy this class and modify the transforms to match your dataset based on the
    comments below.
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_robotwin_moe_skill_pretrain",
        ...
        data=LeRobotRobotwinSkillDataConfig(
    ...
    TrainConfig(
        name="pi05_robotwin_moe_skill_transfer",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
